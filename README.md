...
| Name                               | Description                                                                                                                                                                                                                                              | Value    |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `common.nameOverride`              | String to fully override application.name template for all resources                                                                                                                                                                                     | `""`     |
...
| `common.labels.managedBy`          | Managed-by label to specify the tool managing the resource                                                                                                                                                                                               | `ArgoCD` |
